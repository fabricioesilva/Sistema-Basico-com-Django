...
class PolicyRules(models.Model):
    ...
    created_date = models.DateTimeField(
        _("Data da criação"), default=timezone.now, null=True, blank=True)
...
class PolicyAcepted(models.Model):
    ...
    acept_date = models.DateTimeField(
        _("Data da aceitação"), default=timezone.now)
...
class PolicyChanges(models.Model):
    ...
    mod_date = models.DateTimeField(
        _("Data da modificação"), default=timezone.now, null=True)
